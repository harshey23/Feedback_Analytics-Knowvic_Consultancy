...
<body>
			...
			<ul class="cd-top-nav">
				...
				<li class="has-children account">
					...
					<ul>
						...
						<li><a href="/feedback/logout.php">Logout</a></li>
					</ul>
				</li>
			</ul>
		</nav>
	...
	<main class="cd-main-content">
		<nav class="cd-side-nav">
			<ul>
				...
				<li class="has-children overview">
					<a href="#piechart1">Home</a>
				</li>
				<li class="has-children bookmarks">
					<a><font color="skyblue";>Total Feedbacks</font><span class="count"><?php echo $fbs;?></span></a>
			...
			<ul>
				<li class="cd-label">Reports</li>
				<li class="has-children images">
					<a href="#piechart1">Domain</a>
				...
				<li class="has-children images">
					<a href="#piechart2">Technologies</a>
				...
				<li class="has-children images">
					<a href="#piechart3">Soft Skills</a>
				...
				<li class="has-children bookmarks">
					<a href="#get_report">Get Excel Reports</a>
					
					<ul>
						<li><a href="#get_report">1. Domain</a></li>
						<li><a href="#get_report">2. Technologies</a></li>
						<li><a href="#get_report">3. Soft skills</a></li>
					</ul>
				</li>
			</ul>
			...
			<ul>
				...
				<li class="has-children">
					<a href="#0">Manage Questionnaire</a>
					
				<!-- 	<ul>
						<li><a href="#0">Add Question</a></li>
						<li><a href="#0">Edit question</a></li>
						<li><a href="#0">Delete Question</a></li>
					</ul> -->
				</li>
				<li class="has-children">
					<a href="#0">Manage Companies</a>
		...
		<div id="piechart1" style=" padding-left: 250px; width: 1200px; height: 400px;">
			
		</div>
			</div> <!-- .content-wrapper -->
		<div id="piechart2" style=" padding-left: 250px; width: 1200px; height: 400px;">
			
		</div>
			</div> <!-- .content-wrapper -->
		<div id="piechart3" style=" padding-left: 250px; width: 1200px; height: 400px;">
...
<div class="container">
	<div id="get_report" style="padding-top: 20px; padding-left: 250px; float: left;">	
		<div id="table_wrapper1" style=" width: 220px; float: left;">
         ...
         <div class="btn">
            <button id="btnExport1" type="button" class="btn btn-primary">Domain Report</button>
         </div>
		</div>
		<div id="table_wrapper2" style=" width: 260px; padding-left: 80px;float: left;">
			...
			<table class="table table-bordered table-inverse table-responsive">
		     ...
		     <div class="btn">
            <button type="button" id="btnExport2" class="btn btn-primary">Technology Report</button>
             </div>
		</div>
		...
		<div id="table_wrapper3" style=" width: 280px; padding-left: 80px;float: left;">
          ...
          <th>No of Surveys</th>
				...
				<div class="btn">
            <button type="button" id="btnExport3" class="btn btn-primary">Soft Skills Report</button>
                </div>
		</div>
	</div>
...
<h2 class="center" style="padding-left: 160px;"><strong>Report Generation</strong>  </h2>
    ...
    <div class="row">
      ...
      <div>      
            ...
            <div>
             ...
             <div class="btn">
                    <button type="button" id="exportGetdata1" class="btn btn-danger">Get Report</button>
               </div>
      </div> 
    </div>

<div id="data_id_11" style="padding-left: 350px;"><b></b>
...
<div class="row">
      ...
      <div>      
            ...
            <form>
            <div>
               <select name="tech" id="data_id_2" class="selectpicker col-lg-4" data-style="btn-primary" title="Choose one of the following..." style="color:white;" onchange="getData_2(this.value)">
             ...
             <div class="btn">
                    <button type="button" id="exportGetdata2" class="btn btn-danger">Get Report</button>
               </div>
      </div> 
    </div>
    <div id="data_id_22" style="padding-left: 350px;"><b> </b></div>
  ...
  <div class="row">
      ...
      <div>      
            ...
            <div class="btn">
            <button type="button" id="exportGetdata3" class="btn btn-danger">Get Report</button>
                </div>
      </div> 
    </div>

<div id="data_id_33" style="padding-left: 350px;"><b></b></div>
...
<div style="padding-left: 160px; padding-top: 40px;">
	...
	<h2 class="center"><strong>Company Management</strong>  </h2>
</div>
...
<div class="row" style="padding-top: 40px;">
        <div>
            <h4 class="col-lg-4">Company name:</h4>
        </div>
       <div class="form-group">
        <div class="inputGroupContainer">

          <div class="input-group" style="padding-left: 70px; width: 90%">
             <input type="text" name="cn_name" id="cn_name" placeholder="Type your answer here" class="form-control" required="required" style="width: 435px;">
    ...
    <div>
            <h4 class="col-lg-4">Company type:</h4>
        </div>
       
           <div style="padding-left: 80px;">
               <select name="company_type" id="ct_id" class="selectpicker" data-style="btn-primary" title="Select the Type of the Company" style="color:white;">
                  ...
                  <?php
                      ...
                      $sql_query = "SELECT TYPE_ID,TYPE FROM COMPANY_TYPE_T ORDER BY TYPE";
    ...
    <div class="row" style="padding-left: 210px; padding-top: 5px;">
      <button type="submit" id="addcompany" class="btn btn-danger" onclick="addcompany()">ADD</button>
    </div>
  ...
  <div  id="successmsg" style="padding-left: 170px;  font-size: 22px; padding-top: 5px; padding-bottom: 30px;"></div> 
...
<script type="text/javascript">
	function addcompany(){
        ...
        xmlhttp.open("GET","addCompany.php?cn="+com+"&cid="+ctid,true);
        xmlhttp.send();
    }
	}
</script>
